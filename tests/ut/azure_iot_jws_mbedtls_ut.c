...
static uint8_t ucAzureIoTADURootKeyId[ 13 ] = "ADU.200702.R";
static uint8_t ucAzureIoTADURootKeyN[ 385 ]
    =
    {
...
AzureIoTJWS_RootKey_t xADURootKey =
{
    ...
    .pucRootKeyN             = ucAzureIoTADURootKeyN,
    .ulRootKeyNLength        = sizeof( ucAzureIoTADURootKeyN ),
    .pucRootKeyExponent      = ucAzureIoTADURootKeyE,
    .ulRootKeyExponentLength = sizeof( ucAzureIoTADURootKeyE )
};
...
static void testAzureIoTJWS_ManifestAuthenticate_Success( void ** ppvState )
{
    assert_int_equal( AzureIoTJWS_ManifestAuthenticate( ucValidManifest, strlen( ucValidManifest ),
                                                        ucValidManifestJWS, strlen( ucValidManifestJWS ), &xADURootKey,
...
{
    assert_int_equal( AzureIoTJWS_ManifestAuthenticate( ucValidManifest, strlen( ucValidManifest ),
                                                        ucWrongSHAManifestJWS, strlen( ucWrongSHAManifestJWS ), &xADURootKey,
                                                        ucScratchBuffer, sizeof( ucScratchBuffer ) ), eAzureIoTErrorFailed );
}
