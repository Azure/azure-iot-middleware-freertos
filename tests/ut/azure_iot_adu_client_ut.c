...
static uint8_t ucSendStatePayload[] = "{\"deviceUpdate\":{\"__t\":\"c\",\"agent\":{\"deviceProperties\":{\"manufacturer\":\"Contoso\",\"model\":\"Foobar\",\"interfaceId\":\"dtmi:azure:iot:deviceUpdateModel;1\",\"aduVer\":\"DU;agent/0.8.0-rc1-public-preview\",\"doVer\":\"" testDO_VERSION "\"},\"compatPropertyNames\":\"manufacturer,model\",\"state\":0,\"installedUpdateId\":\"{\\\"provider\\\":\\\"Contoso\\\",\\\"name\\\":\\\"Foobar\\\",\\\"version\\\":\\\"1.0\\\"}\"}}}";
...
\"interfaceId\":\"dtmi:azure:iot:deviceUpdateModel;1\",\"aduVer\":\"DU;agent/0.8.0-rc1-public-preview\",\"doVer\":\"" testDO_VERSION "\"},\
...
static void ParseRequest_Success(uint8_t* request_payload, int32_t request_payload_size)
{
    AzureIoTADUClient_t xTestIoTADUClient;
    AzureIoTJSONReader_t xReader;
    AzureIoTADUUpdateRequest_t xRequest;
    ...
    assert_int_equal( xRequest.xUpdateManifest.pxFiles[ 0 ].ulSizeInBytes, ucFilesSizeInBytes );
...
static void testAzureIoTADUClient_ParseRequest_NoDeploymentNullManifest_Success( void ** ppvState )
{
    ...
    assert_int_equal( AzureIoTJSONReader_Init( &xReader, ucADURequestPayloadNoDeployementNullManifest, sizeof( ucADURequestPayloadNoDeployementNullManifest ) - 1 ), eAzureIoTSuccess );
