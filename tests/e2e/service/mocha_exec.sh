...
npm run iothub_e2e_test --loglevel verbose
npm run iothub_e2e_test_using_dm --loglevel verbose
npm run iot_provisioning_e2e_test --loglevel verbose
npm run iot_provisioning_e2e_test_using_dm --loglevel verbose
