                                  ...
                                  uint16_t usPacketId )
{
    ...
    configASSERT( ( pxIncomingPacket->ucType & azureiotmqttPACKET_TYPE_BIT_MASK ) == azureiotmqttPACKET_TYPE_SUBACK );
                              ...
                              AzureIoTMQTTDeserializedInfo_t * pxDeserializedInfo )
{
    ...
    if( ( pxPacketInfo->ucType & azureiotmqttPACKET_TYPE_BIT_MASK ) == azureiotmqttPACKET_TYPE_PUBLISH )
    {
        prvMQTTProcessIncomingPublish( pxAzureIoTHubClient, pxDeserializedInfo->pxPublishInfo );
    }
    else if( ( pxPacketInfo->ucType & azureiotmqttPACKET_TYPE_BIT_MASK ) == azureiotmqttPACKET_TYPE_SUBACK )
    {
