 ...
 *
 * @param[out] json_writer_ptr A pointer to an #AzureIoTJSONWriter_t the instance to initialize.
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_Init( AzureIoTJSONWriter_t * json_writer_ptr,
                                                   uint8_t * buffer_ptr,
                                                   uint16_t buffer_len );
 ...
 *
 * @param[out] json_writer_ptr A pointer to an #AzureIoTJSONWriter_t the instance to de-initialize.
 *
 * @return An #AzureIoTHubClientResult_t value indicating the result of the operation.
 * @retval #eAzureIoTHubClientSuccess Successfully de-initialized JSON writer.
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_Deinit( AzureIoTJSONWriter_t * json_writer_ptr );

/**
 * @brief Appends the UTF-8 property name and value where value is int32
 *
 * @param[in] json_writer_ptr A pointer to an #AzureIoTJSONWriter_t.
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendPropertyWithInt32Value( AzureIoTJSONWriter_t * json_writer_ptr,
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendPropertyWithDoubleValue( AzureIoTJSONWriter_t * json_writer_ptr,
                                                                            const uint8_t * property_name,
                                                                            uint16_t property_name_len,
                                                                            double value,
                                                                            uint16_t fractional_digits );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendPropertyWithBoolValue( AzureIoTJSONWriter_t * json_writer_ptr,
                                                                          const uint8_t * property_name,
                                                                          uint16_t property_name_len,
                                                                          uint16_t value );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendPropertyWithStringValue( AzureIoTJSONWriter_t * json_writer_ptr,
                                                                            const uint8_t * property_name,
                                                                            uint16_t property_name_len,
                                                                            const uint8_t * value,
                                                                            uint16_t value_len );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_GetBytesUsed( AzureIoTJSONWriter_t * json_writer_ptr );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendString( AzureIoTJSONWriter_t * json_writer_ptr,
                                                           const uint8_t * value,
                                                           uint16_t value_len );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendJsonText( AzureIoTJSONWriter_t * json_writer_ptr,
                                                             const uint8_t * json,
                                                             uint16_t json_len );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendPropertyName( AzureIoTJSONWriter_t * json_writer_ptr,
                                                                 const uint8_t * value,
                                                                 uint16_t value_len );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendBool( AzureIoTJSONWriter_t * json_writer_ptr,
                                                         uint16_t value );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendInt32( AzureIoTJSONWriter_t * json_writer_ptr,
                                                          int32_t value );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendDouble( AzureIoTJSONWriter_t * json_writer_ptr,
                                                           double value,
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendNull( AzureIoTJSONWriter_t * json_writer_ptr );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendBeginObject( AzureIoTJSONWriter_t * json_writer_ptr );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendBeginArray( AzureIoTJSONWriter_t * json_writer_ptr );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendEndObject( AzureIoTJSONWriter_t * json_writer_ptr );
 ...
 */
AzureIoTHubClientResult_t AzureIoTJSONWriter_AppendEndArray( AzureIoTJSONWriter_t * json_writer_ptr );
