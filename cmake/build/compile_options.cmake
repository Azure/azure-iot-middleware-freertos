...
function(az_add_compile_options _TARGET)
  ...
  elseif(CMAKE_C_COMPILER_ID MATCHES "Clang")
    ...
    target_compile_options(${_TARGET} PRIVATE -Xclang -Wall -Wextra -pedantic  ${WARNINGS_AS_ERRORS_FLAG} -Wdocumentation -Wdocumentation-unknown-command -fcomment-block-commands=retval -Wunused -Wuninitialized -Wmissing-declarations -Wconversion -Wpointer-arith -Wshadow -Wfloat-equal)
  else()
    if(WARNINGS_AS_ERRORS)
      set(WARNINGS_AS_ERRORS_FLAG "-Werror")
    endif()
